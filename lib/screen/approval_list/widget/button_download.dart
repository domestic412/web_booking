...
class _DownloadButtonApprovalState extends State<DownloadButtonApproval> {
  ...
  Future<void> downloadFile(String fromDate, String toDate) async {
    ...
    final url = '$SERVER/Requests/Export?fromDay=$fromDate&toDay=$toDate'; // Replace with your direct link
    ...
    if (response.statusCode == 200) {
      ...
      final anchor = html.AnchorElement(href: url)
        ..setAttribute('download', 'Requests List.xlsx') // Change file name and extension as needed
        ..click();
