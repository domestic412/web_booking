...
class DataTableBookingRequest extends DataTableSource {
  ...
  DataTableBookingRequest({this.data});
  ...
  DataRow? getRow(int index) {
    ...
    if (rowData.statusBooking == 'A') {
      _color = green;
      _trangthai = 'Đồng ý';
    } else if (rowData.statusBooking == 'N') {
      ...
      DataCell(Container(
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            controller.selectWidget.value = detailBookingRequest;
          },
