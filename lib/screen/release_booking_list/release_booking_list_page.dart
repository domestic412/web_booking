...
class ReleaseBookingListPage extends StatefulWidget {
  @override
  State<ReleaseBookingListPage> createState() => _ReleaseBookingListPageState();
}

class _ReleaseBookingListPageState extends State<ReleaseBookingListPage> {
  DataTableReleaseBookingRequest _dataBookingRequest =
      DataTableReleaseBookingRequest(data: []);
  DataTableReleaseBookingRequest _list_filter =
      DataTableReleaseBookingRequest(data: []);
  ...
  void initState() {
    super.initState();
    try {
      BookingRequest().fetchBookingRequestListAll().then((data) => {
            setState(() {
              _dataBookingRequest = DataTableReleaseBookingRequest(data: data);
  ...
  void _filterBookingRequest() {
    try {
      setState(() {
        ...
        _list_filter = DataTableReleaseBookingRequest(data: filterData);
      });
    } catch (e) {
                            ...
                            child: Center(
                              child: InkWell(
                                onTap: () {
                                  setState(() {
                                    _list_filter =
                                        DataTableReleaseBookingRequest(
