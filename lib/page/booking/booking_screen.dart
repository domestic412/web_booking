          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    SelectableText('Booking Request', style: style20_blue,),
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            onTap: () async {
                              ...
                              if (pickeddate != null) {
                                setState(() {
                                  date_select.text = DateFormat('MM/dd/yyyy').format(pickeddate);
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){
                          if (idPort1 == idPort2) {
                            ...
                            setState(() {
                              fetchVoyage = fetchDataVoyage(idPort1.toString(), idPort2.toString(), date_select.text);
                            });
                          }
                        }, child: Text('Tìm chuyến tàu', 
                        // style: text_style3
                        )),
                    ),
                    SizedBox(height: 20,),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(nameVoyage.toString(), 
                              // style: text_style4,
                              ),
                            ),
                            Container(
                              width: 300,
                              alignment: Alignment.bottomRight,
                              child: Text(dateVoyage.toString().substring(0, 10), 
                              // style: text_style4,
                              ),
                            )
                          ],
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Text('Tên depo: ' + nameDepo.toString(), 
                              // style: text_style4,
                              ),
                              SizedBox(width: 90,),
                              Text('Số lượng container:  ', 
                              // style: text_style4,
                              ),
                              Container(
                                height: 40,
